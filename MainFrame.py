...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Img_show.setGeometry(QtCore.QRect(20, 20, 641, 471))
        self.Img_show.setCursor(QtGui.QCursor(QtCore.Qt.ArrowCursor))
        self.Img_show.setFrameShape(QtWidgets.QFrame.Box)
        self.Img_show.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.Img_show.setTextFormat(QtCore.Qt.AutoText)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Img_show.setText(_translate("MainWindow", "Image"))
