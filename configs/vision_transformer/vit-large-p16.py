...
checkpoint = '/database/ygxiong/mmpretrain/pretrained/mae_vit-large-p16_8xb512-fp16-coslr-400e_in1k_20220825-b11d0425.pth'
...
model = dict(
    backbone=dict(
        ...
        init_cfg=dict(
            checkpoint=
            '/database/ygxiong/mmpretrain/pretrained/mae_vit-large-p16_8xb512-fp16-coslr-400e_in1k_20220825-b11d0425.pth',
            prefix='backbone.',
            type='Pretrained'),
...
test_dataloader = dict(
    ...
    dataset=dict(
        data_root='/database/ygxiong/mmpretrain/data/domars16k/test',
        pipeline=[
...
train_dataloader = dict(
    ...
    collate_fn=dict(type='default_collate'),
    dataset=dict(
        data_root='/database/ygxiong/mmpretrain/data/domars16k/train',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                backend='pillow',
...
val_evaluator = [
    ...
    dict(average=None, type='MultiLabelMetric'),
]
vis_backends = [
