...
def main():
    ...
    parser.add_argument('--src',
                        default='/database/ygxiong/mmsegmentation/pretrained/mae_pretrain_vit_base.pth',
                        help='src model path or url')
    # The dst path must be a full path of the new checkpoint.
    parser.add_argument('--dst',
                        default='/database/ygxiong/mmsegmentation/pretrained/mae_pretrain_vit_base_converter.pth',
                        help='save path')
