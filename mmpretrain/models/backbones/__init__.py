...
from .a_marsmapformer_35 import MarsMapFormer_35
from .vision_transformer_marsmapformer import VisionTransformer_marsmapformer
from .mvit_mars1 import MViT_mars1
from .mvit_mars2 import MViT_mars2
from .smt import SMT
...
__all__ = [
    ...
    'MViT_mars2',
    'MViT_mars1',
    'VisionTransformer_marsmapformer',
    'MarsMapFormer_35',
    'LeNet5',
    'AlexNet',
    'VGG',
